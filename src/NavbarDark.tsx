    ...
    <>
      ...
      >
        ...
        <ul
          className={`${
            isAtTop
              ? "hover:px-6 gap-5 px-8 right-0 w-[490px] border-[0.5px] border-gray-400 shadow-md h-[55px] fixed transition-all duration-1000 ease-in-out"
        ...
        <div
          className={`${
            isAtTop && window.innerWidth >= 768
              ...
              : "max-h-[55px] min-h-[55px] shadow-md rounded-full min-w-[55px] ml-2 p-3 fixed transition-all duration-1000 ease-in-out"
          } h-full p-1.5 items-center bg-white border-[0.5px] border-gray-300 cursor-pointer rounded-r-full transition-all duration-1000 ease-in-out`}
          onClick={openModal}
        >
          <img
            loading="lazy"
        ...
        <ul
          ...
          className={`${
            isAtTop && window.innerWidth >= 768
              ...
              : `gap-5 cursor-pointer px-8 transition-all duration-500 ease-in-out ${
                  isExpanded
                    ? "pl-7 right-0 mt-[215px] transition-all rounded-l-3xl flex-col py-[7px] overflow-hidden text-[18px] flex w-[130px] pb-[270px] duration-200 ease-in-out"
                    : "pl-7 right-[0vw] lg:right-[0vw] w-[120px] transition-all duration-200 ease-in-out"
                } group cursor-auto shadow-md h-[55px] fixed transition-all duration-1000 ease-in-out`
          } flex h-[55px] font-medium items-center rounded-l-3xl bg-white border-[0.5px] border-gray-300 transition-all duration-1000 ease-in-out`}
        >
          {" "}
          <li
            className={`${
