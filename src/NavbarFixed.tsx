...
const NavbarFixed = () => {
  ...
  return (
    <>
      <div className="navbar-container navbar-large-screen h-[7vh] w-full absolute z-50 mt-7 flex items-center justify-between text-black scroll-smooth transition-all duration-1000 ease-in-out">
        <div
      ...
      <div
        className={`navbar-container navbar-small-screen h-[7vh] w-full absolute mt-7 flex items-center justify-between text-black transition-all duration-1000 ease-in-out ${
